...
export const layersEn: Layer[] = [
  {
    ...
    brk: "GateKPT starts here: <em>prompts, notes, files, constraints, and intent.</em>",
    details: [
      "The work begins by turning loose ideas into usable instructions.",
      "Good inputs reduce guessing before any model runs.",
      "This is the same discipline behind notes, audio briefs, and product specs.",
    ],
  },
  {
    id: "L02",
  ...
  },
  {
    ...
    details: [
      "GateKPT separates public notes from private work.",
