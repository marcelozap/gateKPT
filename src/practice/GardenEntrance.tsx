...
export default function GardenEntrance() {
  return <section className="garden-entrance" aria-labelledby="garden-title">
    ...
    <div className="garden-copy"><p>Room to move. Room to make music.</p><h1 id="garden-title">Singing Practice</h1><a href="#movement-title">Come on in <ArrowDown size={18}/></a></div>
