...
export const layersEs: Layer[] = [
  {
    ...
    src: "OpenAI Help, Tokens",
    srcUrl: "https://help.openai.com/en/articles/4936856-what-are-tokens-and-how-to-count-them",
    brk: "La primera capa no es magia. <em>Es la instrucción que pones en el sistema.</em>",
    details: [
      "La app convierte tu mensaje, archivos, imágenes y límites en una solicitud.",
      "Mejores entradas reducen adivinanza porque el sistema recibe más estructura.",
      "Aquí una persona de negocio puede mejorar resultados de inmediato.",
    ],
  },
  {
    id: "L02",
    ...
    src: "OpenAI Help, Tokens",
    srcUrl: "https://help.openai.com/en/articles/4936856-what-are-tokens-and-how-to-count-them",
    brk: "Tú escribes frases. <em>El modelo ve partes de texto llamadas tokens.</em>",
    details: [
      "Los modelos procesan piezas de texto, no frases humanas completas.",
      "Más contexto cuesta más memoria y cómputo.",
      "Los límites de tokens deciden cuánto puede mantener el modelo a la vista.",
    ],
  },
  {
    id: "L03",
    name: "Contexto",
    essence: "La app decide qué más debe ver el modelo antes de responder.",
    fig: "RAG",
    unit: "",
    figcap: "La recuperación puede agregar contexto externo relevante a una solicitud.",
    src: "OpenAI API, Prompt engineering",
    srcUrl: "https://developers.openai.com/api/docs/guides/prompt-engineering",
    brk: "Tu prompt es solo una parte. <em>Archivos, memoria, búsqueda e instrucciones forman la respuesta.</em>",
    details: [
      "La app puede agregar instrucciones, archivos, búsqueda o memoria guardada.",
      "Mal contexto puede hacer que un modelo fuerte responda mal.",
      "Por eso importan el formato, la recuperación y la calidad de fuentes.",
    ],
  },
  {
    id: "L04",
    name: "Modelos",
    essence: "El modelo genera una respuesta desde la entrada y el contexto que recibió.",
    fig: "next",
    unit: "",
    figcap: "Los modelos de texto procesan texto en tokens y generan texto desde ese contexto.",
    src: "OpenAI API, Key concepts",
    srcUrl: "https://developers.openai.com/api/docs/concepts",
    brk: "El modelo no lee tu mente. <em>Produce el siguiente texto útil desde el contexto.</em>",
    details: [
      "El modelo genera tokens probables desde el contexto que recibió.",
      "Puede sonar seguro sin estar correcto.",
      "Las pruebas deciden si la respuesta es suficientemente útil para confiar.",
    ],
  },
  {
    id: "L05",
    name: "Herramientas",
    essence: "La IA útil muchas veces sale del modelo para buscar, calcular, leer o actuar.",
    fig: "call",
    unit: "",
    ...
    details: [
      ...
      "Aquí un chatbot se vuelve una capa operativa para el trabajo.",
      "Permisos, registros y revisión importan cuando el sistema puede actuar.",
    ],
  },
  {
    id: "L06",
    name: "Chips",
    essence: "Todo ese pensamiento todavía tiene que correr en hardware.",
    fig: "3",
    unit: "TB/s",
    figcap: "Ancho de banda de memoria en un chip NVIDIA H100.",
    src: "NVIDIA, H100 overview",
    srcUrl: "https://www.nvidia.com/en-us/data-center/h100/",
    brk: "La respuesta parece instantánea. <em>Debajo, los chips mueven datos a velocidad física.</em>",
    details: [
      "Los GPU corren muchas operaciones matemáticas en paralelo.",
  ...
  },
  {
    id: "L07",
    name: "Energía",
    essence: "La última capa es física: electricidad, enfriamiento, edificios y acceso a la red.",
    fig: "5+",
    unit: "años",
    figcap: "Espera mediana para conectar un nuevo proyecto a la red eléctrica de EE. UU.",
    src: "Berkeley Lab, Queued Up 2026",
    srcUrl: "https://emp.lbl.gov/publications/queued-2026-edition-characteristics",
    brk: "La experiencia empieza con texto. <em>El límite puede terminar en una conexión eléctrica.</em>",
    details: [
      "Los centros de datos necesitan electricidad, enfriamiento, terreno y acceso a la red.",
      "Las comunidades sienten la expansión en impuestos, facturas, permisos y ruido.",
...
export const localeCopy = {
  ...
  es: {
    ...
    endKicker: "L01 - L07",
    endTitle: "La IA es física, lógica y humana.",
    endBody:
      "La experiencia empieza cerca de ti y se mueve hacia afuera. Una frase se vuelve tokens, contexto, modelo, herramientas, chips y energía física.",
