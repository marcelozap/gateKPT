...
export const layersEn: Layer[] = [
  {
    id: "L01",
    name: "Input",
    essence: "A system starts with the thing you hand it.",
    fig: "1",
    unit: "ask",
    ...
    brk: "GateKPT starts here: <em>prompts, journal entries, files, constraints, and intent.</em>",
    details: [
      "The work begins by turning loose ideas into usable instructions.",
      "Good inputs reduce guessing before any model runs.",
      "This is the same discipline behind journal entries, audio briefs, and product specs.",
    ],
  },
  {
    id: "L02",
    name: "Tokens",
    essence: "Text becomes model-readable structure.",
    fig: "4",
    unit: "chars",
    figcap: "OpenAI's rough rule of thumb: one token is about four English characters.",
    src: "OpenAI Help, Tokens",
    srcUrl: "https://help.openai.com/en/articles/4936856-what-are-tokens-and-how-to-count-them",
    brk: "The sentence becomes parts. <em>That is where writing turns into computation.</em>",
    details: [
      "Models process pieces of text, not whole human meaning.",
      "Token limits shape what the system can keep in view.",
      "GateKPT treats formatting as engineering, not decoration.",
    ],
  },
  {
    id: "L03",
    name: "Context",
    essence: "The useful answer depends on what the model is allowed to see.",
    fig: "RAG",
    unit: "",
    ...
    brk: "Your prompt is only the front door. <em>Files, memory, sources, and boundaries shape the answer.</em>",
    details: [
      "GateKPT separates the public record from private work.",
      "MaloSound and GreenMachine stay linked, not copied into this site.",
      "Good context is a data contract with the model.",
    ],
  },
  {
    id: "L04",
    name: "Models",
    essence: "The model works inside the context it receives.",
    fig: "next",
    unit: "",
    ...
    brk: "The model is not a claim by itself. <em>The system around it decides whether the result is useful.</em>",
    details: [
      "LLMs help plan, write, debug, compare, and explain.",
      "The honest part is verification: what passed, what failed, what is unknown.",
      "A useful system can say no when the signal is too weak.",
    ],
  },
  {
    id: "L05",
    name: "Tools",
    essence: "Real AI work uses tools, files, builds, and checks.",
    fig: "call",
    unit: "",
    ...
    brk: "A chatbot talks. <em>A working system reads, builds, tests, links, and ships.</em>",
    details: [
      "Codex, Claude, GitHub, local files, builds, and browser QA are part of the workflow.",
      "Tools make the work inspectable instead of just conversational.",
      "Permissions and logs matter once the system can act.",
    ],
  },
  {
    id: "L06",
    name: "Chips",
    essence: "Visuals, audio, and models still run on hardware.",
    fig: "3",
    unit: "TB/s",
    ...
    brk: "The page feels fluid. <em>Underneath it, math, rendering, memory, and chips are doing the work.</em>",
    details: [
      "The dancing body is generated geometry and signal mapping.",
      "Audio analysis and visual rendering are both compute problems.",
  ...
  },
  {
    id: "L07",
    name: "Power",
    essence: "Every digital system eventually touches physical infrastructure.",
    fig: "5+",
    unit: "yr",
    ...
    brk: "The experience starts with text. <em>The limit can end at deployment, power, cooling, or cost.</em>",
    details: [
      "Data centers need electricity, cooling, land, and grid access.",
      "Deployment turns experiments into something other people can open.",
...
export const localeCopy = {
  en: {
    ...
    countBoot: "START",
    homeTitle: "The Record for understanding AI as a system.",
    homeBody:
      "GateKPT starts with Marcelo's journal entries, then opens what happens after you type: input, tokens, context, models, tools, chips, and power.",
    openLog: "Read latest entry",
    exploreMap: "Learn the layers",
    layers: "AI layers",
    writingBadge: "The Record",
