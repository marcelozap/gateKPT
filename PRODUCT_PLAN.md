...
1. Hero
   - Explain the experiment in one sentence.
   - Communicate play, no download, no account, and no pressure.
...
4. Public Demo
   ...
   - Opens only after a click.
   - Uses 2D canvas.
   - Has Exit demo.
   - Esc exits demo.
   - No upload, backend, AI call, or private files.

5. Product Sections
   - who it is for
   - private MusicOS experiment
...
The private GateKPT MusicOS can have the serious 2D/3D renderer.
...
- C#/.NET
- local-first
- Focusrite / RC-505 aware
- 3D-capable later
- projector/performance focused
